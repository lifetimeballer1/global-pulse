...
def fetch(q):
 u='https://api.gdeltproject.org/api/v2/doc/doc?query='+quote(q)+'&mode=artlist&format=rss&maxrecords=75&timespan=15min&sort=datedesc';req=Request(u,headers={'User-Agent':'GlobalPulse/10.0','Accept':'application/rss+xml, application/xml'})
