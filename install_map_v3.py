#!/usr/bin/env python3
"""Keep the canonical 2D map installer isolated and remove the deprecated 3D globe.

The 3D experiment is intentionally disabled for now. This script does not
replace or rebuild the canonical Leaflet map; it only removes any stale 3D
installer block left in index.html.
"""
